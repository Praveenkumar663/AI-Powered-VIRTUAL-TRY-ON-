...
def repwalpha():
    ...
    src = cv2.imread("../Sample/Virtual-Clothing-Try-On-main/Virtual Clothing Try on/cut_image.png", 1)
    ...
    cv2.imwrite("../Sample/Virtual-Clothing-Try-On-main/Virtual Clothing Try on/cut_image.png", dst)
    ...
    if(results.pose_landmarks):
        ...
        for id, lm in enumerate(results.pose_landmarks.landmark):
            ...
            if id==32:
                ...
                repwalpha()
                # print("Got back")
                overlay = Image.open("../Sample/Virtual-Clothing-Try-On-main/Virtual Clothing Try on/cut_image.png")
